...
export const SHAPES: Record<string, ShapeDefinition> = {
  ...
  cube: {
    ...
    badgeColor: 'bg-[#d6b6f6]/20 text-[#391c57] border-[#d6b6f6]',
  ...
  rectangular_prism: {
    ...
    category: 'basic',
    categoryLabel: 'Basic 3D',
    badgeColor: 'bg-[#62aef0]/20 text-[#005bab] border-[#62aef0]',
  ...
  cylinder: {
    ...
    badgeColor: 'bg-[#2a9d99]/20 text-[#13615e] border-[#2a9d99]',
  ...
  sphere: {
    ...
    category: 'curved',
    categoryLabel: 'Curved Shapes',
    badgeColor: 'bg-[#ff64c8]/20 text-[#a31a75] border-[#ff64c8]',
  ...
  cone: {
    ...
    category: 'curved',
    categoryLabel: 'Curved Shapes',
    badgeColor: 'bg-[#dd5b00]/20 text-[#793400] border-[#dd5b00]',
  ...
  capsule: {
    ...
    category: 'curved',
    categoryLabel: 'Curved Shapes',
    badgeColor: 'bg-[#1aae39]/20 text-[#0f6b23] border-[#1aae39]',
